# Moyo header
Create an HTML page with the header using `flexbox` based on the [Figma Mockup](npm ).
...
- [DEMO LINK](https://mkravchuk97.github.io/layout_moyo-header/)
- [TEST REPORT LINK](https://mkravchuk97.github.io/layout_moyo-header/report/html_report/)
